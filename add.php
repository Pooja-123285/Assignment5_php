...
<body>
    ...
    <table border="1" cellspacing="10" cellpadding="10" style="margin-top:150px;background-color:grey">
    <tr><th colspan="2" style="margin-top:150px;background-color:yellow;font-size:30px;">Passport Details</th></tr>
    ...
    $image = $_REQUEST['img'];
    $sql="INSERT INTO `passport`(`pno`,`f_name`,`m_name`,`l_name`,`dob`,`nation`,`address`,`gender`,`image`) VALUES ('$pno', '$f_name', '$m_name', '$l_name','$dob','$nation','$address','$gender','$image')";
